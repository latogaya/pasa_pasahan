        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (clothesName.isEmpty() || clothesBrand.isEmpty() || clothesPrice.isEmpty()
                    ...
                    dbHelper.addProduct(new Product(clothes_id, clothesName, clothesBrand, Double.parseDouble(clothesPrice), clothesSize, clothesCondition, clothesType, descriptionContent, byteArray));
