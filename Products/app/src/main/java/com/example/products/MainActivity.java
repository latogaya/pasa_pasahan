...
public class MainActivity extends AppCompatActivity implements KolodaListener {
    ...
    public void onCardSwipedLeft(int position) {showAlert("Successfully STOLEN. Please check your Chat");}

    public void onCardSwipedRight(int position) {showAlert("Successfully MINE'd. Please check your Chat");}
